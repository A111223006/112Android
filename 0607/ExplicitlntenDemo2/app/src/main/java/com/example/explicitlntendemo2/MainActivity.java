package com.example.explicitlntendemo2;
...
public class MainActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher launcher = registerForActivityResult(new ResultContrect(),
    ...
    class ResultContrect extends ActivityResultContract<Boolean, String>{
        ...
        public String parseResult(int i, @Nullable Intent intent) {
            ...
            Double result = bundle.getDouble("RESUIT");
